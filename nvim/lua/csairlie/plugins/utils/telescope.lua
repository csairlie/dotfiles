return {
	...
	config = function()
		...
		keymap.set("n", "<leader>ff", "<cmd>Telescope find_files<cr>", { desc = "fzf (cwd)" })
		-- keymap.set("n", "<leader>h", "<cmd>Home<cr>", { desc = "fzf (~/)" })
		keymap.set("n", "<leader>fr", "<cmd>Telescope oldfiles<cr>", { desc = "fzf (recent)" })
		-- keymap.set("n", "<leader>c", "<cmd>Config<cr>", { desc = "fzf (~/config)" }) -- Custom command using Telescope
		keymap.set("n", "<leader>fg", "<cmd>Telescope live_grep<cr>", { desc = "fzf (string in cwd)" })
